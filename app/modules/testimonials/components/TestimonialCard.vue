...
<template>
  <BaseCard as="figure" interactive :class="cn('flex h-full flex-col gap-5 p-6', props.class)">
    <Icon name="lucide:quote" class="size-6 text-primary/60" aria-hidden="true" />
