    ...
    <div v-else class="flex flex-col gap-8">
      ...
      <div class="hidden md:block">
        <Transition name="skill-panel" mode="out-in">
          <div
            v-if="activeGroup"
            :key="activeGroup.id"
            class="glass-surface-strong rounded-2xl p-6 ring-1 ring-primary/15"
          >
            ...
            <div class="flex flex-wrap gap-2">
              <span
                ...
                :key="skill.name"
                class="glass-surface neon-glow inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 font-mono text-xs text-muted-foreground transition-colors hover:text-primary-light"
              >
                <Icon
                  v-if="skill.icon"
                  :name="skill.icon"
      ...
      <div class="grid gap-4 sm:grid-cols-2 md:hidden">
        <div
          ...
          :key="group.id"
          class="glass-surface neon-glow flex flex-col gap-4 rounded-2xl p-5"
        >
          ...
          <div class="flex flex-wrap gap-2">
            <span
              ...
              :key="skill.name"
              class="glass-surface inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 font-mono text-xs text-muted-foreground"
            >
              <Icon
                v-if="skill.icon"
                :name="skill.icon"
